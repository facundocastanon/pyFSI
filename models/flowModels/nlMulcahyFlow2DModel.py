...
class nlMulcahyFlow2D(flowModel, ABC):
    def __repr__(self):
        return 'Nonlinear Mulcahy Flow2DModel '
    ...
    #     '''Calculate the beam force generated by the flow.

    #     Args:
    #         pos (ndarray): Current solid position
    #         vel (ndarray): Current solid velocity

    #     Returns:
    #         nadarray: Beam force (pressure based)
    #     '''
    #     return self.deltaPx[0]
